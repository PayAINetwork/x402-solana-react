...
- Bump `x402-solana` dependency from `^2.0.3` to `^2.0.4`
- Bump various dev dependencies to latest versions

## [2.0.2] - 2026-02-03

### Changed

- Bump `x402-solana` dependency from `^2.0.2` to `^2.0.3` to resolve peer dependency conflicts with `@payai/x402` packages
